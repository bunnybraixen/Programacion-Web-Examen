...
$(function(){
    ...
    $('.btnDivisa').click(function() {
        ...
        $('#precio').text((Number($('#precio').text()) / dolar).toFixed(2))
        $('#precio2').text((Number($('#precio2').text()) / dolar).toFixed(2))
        $('#precio3').text((Number($('#precio3').text()) / dolar).toFixed(2))
        $('#precio4').text((Number($('#precio4').text()) / dolar).toFixed(2))
        $('#precio5').text((Number($('#precio5').text()) / dolar).toFixed(2))
        $('#precio6').text((Number($('#precio6').text()) / dolar).toFixed(2))
